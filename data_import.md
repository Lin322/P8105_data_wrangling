...
One can always check out the help tab (?read.csv()) for more details by typing ?read\_csv in console
...
what about read.csv...? which is build in R and no need to load packages. well, neven use that.
